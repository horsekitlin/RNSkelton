...
export default {
  ...
  // Color
  brandPrimary: 'rgba(86, 182, 169, 1)',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  activeTab: platform === PLATFORM.IOS ? '#007aff' : white,
  sTabBarActiveTextColor: '#007aff',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#2874F0' : white,
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#3F51B5',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : white,
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#007aff' : white,
  ...
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#007aff' : white,
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : white,
  segmentActiveTextColor: platform === PLATFORM.IOS ? white : '#3F51B5',
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : white,
  ...
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#007aff' : white,
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : white,
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#007aff' : white,
  ...
  subtitleColor: platform === PLATFORM.IOS ? black : white,
  titleFontColor: platform === PLATFORM.IOS ? black : white,
